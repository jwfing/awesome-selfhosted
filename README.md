...
- [InsForge](https://insforge.dev/) - Backend built for agentic development, providing auth, databases, file storage, serverless functions, real time and AI gateway. ([Source Code](https://github.com/InsForge/InsForge)) `Apache-2.0` `Docker`
